...
def test_business_aliases():
    ...
    test_cases = [
        ...
        (
            ...
            "Should match CONSEIL SCOLAIRE DE DISTRICT CATHOLIQUE",
        ),
        # Partial matches
        ...
        (
            "CDMPTE DE TAXES SCDLAIRE",
            "Should fuzzy match CONSEIL SCOLAIRE DE DISTRICT CATHOLIQUE",
        ),
    ...
    for test_input, description in test_cases:
        ...
        if result:
            ...
            print(
                f"✅ '{test_input}' -> '{business_name}' ({match_type}, confidence: {confidence:.2f})"
            )
            print(f"   {description}")
        else:
