...
def parse_single_pdf(pdf_path):
    ...
    try:
        ...
        print(f"💰 Total: ${result['invoice_total']}" if result['invoice_total'] else "💰 Total: Not found")
        ...
        print("💡 Install required packages: pip install opencv-python numpy pandas pillow pytesseract pdf2image pdfplumber PyPDF2")
        return None
...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        if not pdf_files:
            ...
            print("Or update PDF_PATH in .env file or place a PDF file in the current directory")
            sys.exit(1)
