...
def test_backup_restore_functionality():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"✅ Modified configuration: {len(current_official_names)} official names")
        ...
        if success:
            ...
            if len(restored_official_names) == 2 and "test-company-3" not in restored_official_names:
...
def test_backup_file_naming():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for backup_path in backup_paths:
            ...
            if filename.startswith("business_mappings_backup_") and filename.endswith(".json"):
